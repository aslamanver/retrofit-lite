...
[ ![Download](https://api.bintray.com/packages/aslam/android/retrofit-lite/images/download.svg?version=1.0.2) ](https://bintray.com/aslam/android/retrofit-lite/1.0.2/link) [![](https://jitpack.io/v/aslamanver/retrofit-lite.svg)](https://jitpack.io/#aslamanver/retrofit-lite) [![Build Status](https://travis-ci.org/aslamanver/retrofit-lite.svg?branch=master)](https://travis-ci.org/aslamanver/retrofit-lite)
